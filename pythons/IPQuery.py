...
class Controller:
    ...
    forcedSign: threading.Event = None
    idleWorker_Sign: threading.Event = None
    idleWorker_Number: multiprocessing.Value = None
    buryingPointer: bool = True
    ...
    def __init__(self, src, target):
        ...
        self.buryingPointer = True
        self.forcedSign = threading.Event()
        self.idleWorker_Sign = threading.Event()
        self.idleWorker_Number = multiprocessing.Value('i', 0)
        ...
        while self.retryTimes < self.center.maxRetryTimes:
            ...
            #     self.state = 2
                ...
                if self.state != 1:
                    ...
                    self.center.idleWorker_Number.value += 1
                    if self.center.idleWorker_Number.value >= self.center.maxWorksNumber / 2:
                        self.center.idleWorker_Number.value = 0
                        self.center.idleWorker_Sign.set()
                if self.center.mutex.locked():
                    self.center.mutex.release()
